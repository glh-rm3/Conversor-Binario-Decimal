...
# Objetivo do projeto
Consegui obter um valor decimal expressivo 2⁶³, que é 9.223.372.036.854.775.807, mas eu poderia converter até 18.446.744.073.709.551.615 utilizando unsigned long long na variável somador, como fiz, mas o que eu realmente tenho é 2⁶³ - 1, um bit é desperdiçado com o sinal (+/-). Tenho novas limitações e novos desafios, como a função pow(), por exemplo. E mais um único bit causa Integer Overflow (Estouro de Inteiro). Talvez seja necessário dar uma olhada em deslocamento de bits. 
